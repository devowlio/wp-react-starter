...
| `npm run db-snapshot-import`                                                                                                                                        | Docker, WP-CLI, DB | The installation snapshot taken                                                                                                                                                                                                                                                                                              |
| with `npm run db-snapshot-installation` is imported to the current running Docker instance. This can be useful for tests for example                                |
...
| `npm run test`                                                                                                                                                      | Tests              | Run all available tests (currently only e2e tests are available)                                                                                                                                                                                                                                                             |
| `npm run test-e2e`                                                                                                                                                  | Tests, Cypress     | Runs the test files in `cypress/integration` in your current running `localhost`                                                                                                                                                                                                                                             |
| `npx cypress open`                                                                                                                                                  | Tests, Cypress     | Opens the Cypress Test Runner as GUI                                                                                                                                                                                                                                                                                         |
